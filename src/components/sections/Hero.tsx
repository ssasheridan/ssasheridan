...
export default function Hero({
  ...
  return (
    <section className="relative min-h-screen sm:min-h-[85vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-navy hero-section-mobile">
      ...
      <motion.p
        className="absolute top-20 right-4 sm:top-8 sm:right-8 md:top-12 md:right-12 z-10 text-xl sm:text-3xl md:text-4xl lg:text-5xl text-khalsa font-serif drop-shadow-lg landscape:top-12 landscape:right-4 landscape:text-lg"
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-12 sm:pt-20 md:pt-24 landscape:pt-8 landscape:pb-4">
        <motion.div
        ...
        >
          {/* Main Title */}
          <motion.h1
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-white mb-3 sm:mb-6 leading-tight px-2 landscape:text-2xl landscape:mb-1"
          ...
          >
            ...
            <span className="block text-khalsa drop-shadow-lg text-2xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mt-1 sm:mt-0 landscape:text-xl landscape:mt-0.5">
          ...
          {/* Subtitle */}
          <motion.p
            className="text-base sm:text-2xl md:text-3xl lg:text-4xl text-white/80 mb-2 sm:mb-4 font-light px-2 landscape:text-xs landscape:mb-1"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {showCTA && (
            <motion.div
              className="flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-20 px-2 landscape:gap-2 landscape:mb-2 landscape:scale-90"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
