...
export default function Hero({
  ...
  return (
    <section className="relative min-h-[85vh] sm:min-h-[85vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-navy">
      ...
      <motion.p
        className="absolute top-24 right-4 sm:top-24 sm:right-8 md:top-28 md:right-12 hidden sm:block z-[110] text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-khalsa font-serif drop-shadow-lg"
